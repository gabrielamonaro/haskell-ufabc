...
/* package listaExtra-0.1.0.0 */
#ifndef VERSION_listaExtra
#define VERSION_listaExtra "0.1.0.0"
#endif /* VERSION_listaExtra */
#ifndef MIN_VERSION_listaExtra
#define MIN_VERSION_listaExtra(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_listaExtra */
...
#define CURRENT_COMPONENT_ID "listaExtra-0.1.0.0-92KrHdHUGdbA4XHGLVLoFO-listaExtra"
