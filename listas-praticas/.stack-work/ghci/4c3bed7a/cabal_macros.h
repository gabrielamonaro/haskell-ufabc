...
/* package listas-praticas-0.1.0.0 */
#ifndef VERSION_listas_praticas
#define VERSION_listas_praticas "0.1.0.0"
#endif /* VERSION_listas_praticas */
#ifndef MIN_VERSION_listas_praticas
#define MIN_VERSION_listas_praticas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_listas_praticas */
...
#define CURRENT_COMPONENT_ID "listas-praticas-0.1.0.0-Gp92TJGc46WKKaLwa0Dpkx-listas-praticas"
